...
For any task that follows the communication model, there exists a processor allocation that achieves $R^{\COM}=\sqrt{2}$.
\end{lemma}
...
\begin{lemma}
For General model, we can obtain $R^{GEN}=2.018$
\end{lemma}
...
\hline
\textbf{Model $M$} & Best Possible (LB) & ICPP22 & TOPC24 & Fair($R^*$) & Fair(1) \\
\hline
Roofline (\ROO) & $\frac{2}{3-\sqrt{5}} > 2.62$ & $2.62$ & $2.62$ & $2.62$ & $2.62$\\
\hline
Comm. (\COM) & $\frac{18}{23-\sqrt{313}} > 3.39$ & $3.61$ & $3.391$  & $3.42$ & $3.70$ \\
\hline
Amdahl (\AMD) & $\frac{2}{1-\sqrt{8\sqrt{2}-11}} > 4.54$  & $4.74$ & $4.55$ & $4.56$ & $5.24$\\
\hline
General (\GEN) & $4.54$ & $5.72$ & $4.58^* (4.63)$ & $4.60$ & $5.29$\\
\hline
Extended COM (COM2) & $4.54$ &  & $4.564^*$ & $4.566$ & $5.25$ \\
\hline
Arbitrary & $\frac{\sqrt{P}}{2}^{**}$ &  &  & $2\sqrt{P}$ & $2.62\sqrt{P}$ \\
\hline
\end{tabular}
